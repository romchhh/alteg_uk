        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex gap-4 justify-center sm:justify-start">
              <a href="#" className="w-10 h-10 bg-white/10 hover:bg-[#445DFE] rounded-full flex items-center justify-center transition-colors" aria-label="Facebook">
                <FacebookIcon className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 bg-white/10 hover:bg-[#445DFE] rounded-full flex items-center justify-center transition-colors" aria-label="LinkedIn">
                <LinkedinIcon className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 bg-white/10 hover:bg-[#445DFE] rounded-full flex items-center justify-center transition-colors" aria-label="Instagram">
